        ...
        <div className="container">
            <form className="mt-4">
                <div className="row">
                    ...
                    <button type="submit" onClick={addinpdata} class="btn btn-primary" style={{width: "200px", marginLeft: "10px"}}>Submit</button>
                    <a href="/home" className="btn btn-primary" style={{width: "200px", marginLeft: "10px"}}>Discard</a>
                </div>
            </form>
        </div>
    )
