                ...
                <CardContent>
                    <div className="row" style={{padding: "20px"}}>
                        ...
                        <div className="right_view  col-lg-6 col-md-6 col-12"style={{padding: "20px"}}>
                            <p className="mt-5" style={{padding: "2px"}}>Employee ID: <span>{getuserdata.mobile}</span></p>
                            <p className="mt-3" style={{padding: "2px"}}>Description: <span>{getuserdata.des}</span></p>
                        </div>
                    </div>
