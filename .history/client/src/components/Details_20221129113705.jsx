            ...
            <Card sx={{ maxWidth: 600 }}>
                <CardContent>
                    <div className="row" style={{ padding: "20px" }}>
                        ...
                        <div className="right_view  col-lg-6 col-md-6 col-12" style={{ padding: "20px" }}>
                            <h4 className="mt-5" style={{ padding: "2px" }}>Email: <span>{getuserdata.email}</span></h4>
                            <h3 className="mt-3" style={{ padding: "2px" }}>Employee ID: <span>{getuserdata.mobile}</span></h3>
