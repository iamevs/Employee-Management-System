                                ...
                                getuserdata.map((val, ind) => {
                                    return (
                                        <tr className=''>
                                            ...
                                            <td>{val.mobile}</td>
                                            <td className='btns'>
                                                <NavLink to={`/induser/${val.mobile}`} className="btn tool" data-tip="More Details"><ReadMoreRoundedIcon /></NavLink>
                                                <NavLink to={`/updateuser/${val.mobile}`} className="btn  tool" data-tip="Edit Details"><NoteAltOutlinedIcon /></NavLink>
